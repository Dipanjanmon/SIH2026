        ...
        <div className="w-full px-4 py-4 flex items-center gap-4">
          ...
          <div className="flex flex-col items-end gap-2 shrink-0">
            <div className="flex items-center gap-2">
              ...
              <button onClick={() => navigate('/dashboard')} className="text-[11px] font-bold text-white bg-[#0a58a0] hover:bg-[#0a4a85] px-5 py-2.5 rounded shadow transition inline-flex items-center gap-1.5">
          ...
          <div className="lg:col-span-2 relative rounded-xl overflow-hidden border border-slate-200 dark:border-gov-700">
            ...
            <div className="absolute inset-x-0 bottom-0 p-4 md:p-6 z-10">
              ...
              <div className="mt-3.5 flex flex-wrap gap-3">
                <button onClick={() => navigate('/dashboard')} className="group inline-flex items-center gap-1.5 text-[11px] font-bold text-white bg-gradient-to-r from-emerald-500 to-emerald-600 px-6 py-2.5 rounded-lg shadow-lg shadow-emerald-900/30 ring-1 ring-white/30 hover:shadow-xl hover:from-emerald-400 hover:to-emerald-500 hover:scale-[1.03] active:scale-[0.98] transition-all duration-200">
                  <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform" /> Get Started
                </button>
                <button onClick={() => navigate('/dashboard')} className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-white bg-white/10 border border-white/40 px-6 py-2.5 rounded-lg backdrop-blur-sm hover:bg-white/25 hover:border-white/70 hover:scale-[1.03] active:scale-[0.98] transition-all duration-200">
          ...
          <div className="max-w-7xl mx-auto w-full px-4 py-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-1.5">
                ...
                <li><a href="#" onClick={() => navigate('/dashboard')} className="hover:underline flex items-center gap-1.5"><ChevronRight className="w-3 h-3 text-emerald-300" /> Command Dashboard</a></li>
